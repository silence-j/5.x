export const getters = {
  ...
  linkerToMail: state => state.linkerToMail,
  stageList: state => state.stageList,
  stageMap: state => state.stageMap,
  userInfoMap: state => state.userInfoMap,
  addCompany: state => state.addCompany,
  addOrNot: state => state.addOrNot,
  addCompanyId: state => state.addCompanyId
}
